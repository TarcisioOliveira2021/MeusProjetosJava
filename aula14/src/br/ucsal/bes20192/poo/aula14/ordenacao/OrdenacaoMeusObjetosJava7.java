...
public class OrdenacaoMeusObjetosJava7 {
	...
	public static void main(String[] args) {
		...
		Comparator<Pessoa> comparadorPessoaAnoNascimento = new ComparadorPessoaAnoNascimento();
		...
		Comparator<Pessoa> comparadorPessoaNomeMaeNome = new ComparadorPessoaNomeMaeNome();
