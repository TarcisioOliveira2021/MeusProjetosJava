...
public class TesteLMD {
	...
	public static void executa(ILMD lista) {
		...
		lista.removeNo(1, 2);
		System.out.println("Esperado: Nova papelaria 10 3, Material de limpeza, Novo alimentos 4 50, Eletrônicos, Novo móveis 60");
		lista.imprimeTudo();
		
		lista.removeNo(3, 50);
		System.out.println("Esperado: Nova papelaria 10 3, Material de limpeza, Novo alimentos 4, Eletrônicos, Novo móveis 60");
		lista.imprimeTudo();
		
		lista.removeNo(5, 60);
		System.out.println("Esperado: Nova papelaria 10 3, Material de limpeza, Novo alimentos 4, Eletrônicos, Novo móveis");
		lista.imprimeTudo();
		...
		lista.remove(3);
		System.out.println("Esperado: Nova papelaria 10 3, Material de limpeza, Eletrônicos, Novo móveis");
		lista.imprimeTudo();
